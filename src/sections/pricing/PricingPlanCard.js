...
export default function PricingPlanCard({ card, index }) {
  ...
  return (
    <RootStyle>
      ...
      {index === 0 && <Button href="/auth/register" fullWidth size="large" variant="contained" disabled={index === 1 || index === 2}>
        {labelAction}
      </Button>}
      {index !== 0 && <Typography variant="body2">Se gostar do teste de 14 dias grátis, poderá assinar este plano!</Typography>}
    </RootStyle>
  );
}

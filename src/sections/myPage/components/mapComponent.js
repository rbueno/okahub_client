...
const { lat, lng, url, placeTitle, placeAddress, component, businessSlug, businessId, pageId, eventEntry } = props
...
const handleEventEntry = () => {
  if ( !['fake_slug', undefined, null].includes(businessSlug)) {
    eventEntry({ component, eventType: 'googleMapsOpen', data: { businessId, _id: pageId } })
  }
}

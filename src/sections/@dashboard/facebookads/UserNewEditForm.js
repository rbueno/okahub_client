          ...
          <Box mb={2}>
            ...
            <Typography variant='subtitle1'>Informações adicionais</Typography>
                  ...
                  fullWidth
                        ...
                        value={data.adOccasion}
                        color="primary"
                        placeholder="Ex.: Black Friday, Primeiro lote, Lançamento"
                        InputLabelProps={{
                          shrink: true,
                        }}
                        // error={newBusinessNameError !== null}
                        onChange={(e) => onChangeAdLabel({ field: 'adOccasion', value: e.target.value })}
                      />
                  </Box>
                  ...
                  fullWidth
                        ...
                        value={data.adPromotion}
                        color="primary"
                        placeholder="Ex.: 30% de desconto, R$ 350,00 de desconto"
                        InputLabelProps={{
                          shrink: true,
                        }}
                        // error={newBusinessNameError !== null}
                        onChange={(e) => onChangeAdLabel({ field: 'adPromotion', value: e.target.value })}
                      />
                  </Box>
          ...
          newAdsGenerated?.adContent?.map(content => <Box key={content} mb={2}>
            <Card sx={{ p: 3 }}>
              <Box>
                <Box mb={2}>
                  <Markdown
                    children={`<b>Ideia de design:</b> ${content.image}`}
                    // sx={{
                    //   px: { md: 5 },
                    // }}
                  />
                  <Markdown
                    children={`<b>Título:</b> ${content.title}`}
                    // sx={{
                    //   px: { md: 5 },
                    // }}
                  />
                  <Markdown
                    children={`<b>Texto principal:</b> ${content.text}`}
                    // sx={{
                    //   px: { md: 5 },
                    // }}
                  />

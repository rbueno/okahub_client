...
// const axiosInstance = axios.create({ baseURL: 'https://minimal-assets-api-dev.vercel.app' || '' });
...
export function getProducts() {
  return async () => {
    ...
    try {
      const response = await axiosInstance.get('v1/app');
      console.log('getProducts response', response)
      dispatch(slice.actions.getProductsSuccess(response.data.apps));
    } catch (error) {

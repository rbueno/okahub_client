...
export const PATH_DASHBOARD = {
  ...
  integration: {
    ...
    shop: path(ROOTS_DASHBOARD, '/integration/shop'),
    list: path(ROOTS_DASHBOARD, '/integration/list'),
    checkout: path(ROOTS_DASHBOARD, '/integration/checkout'),
    new: path(ROOTS_DASHBOARD, '/integration/product/new'),
    view: (name) => path(ROOTS_DASHBOARD, `/integration/product/${name}`),
    edit: (name) => path(ROOTS_DASHBOARD, `/integration/product/${name}/edit`),
    demoEdit: path(ROOTS_DASHBOARD, '/integration/product/nike-blazer-low-77-vintage/edit'),
    demoView: path(ROOTS_DASHBOARD, '/integration/product/nike-air-force-1-ndestrukt'),
  },
  invoice: {
  ...
  customer: {
    detail: (id) => path(ROOTS_DASHBOARD, `/customer/${id}`)
  },
  sales: {
    ...
    demoEdit: path(ROOTS_DASHBOARD, '/sales/e99f09a7-dd88-49d5-b1c8-1daf80c2d7b1/edit'),
    demoView: path(ROOTS_DASHBOARD, '/sales/e99f09a7-dd88-49d5-b1c8-1daf80c2d7b5'),
  },
  blog: {

...
const TABLE_HEAD = [
  { id: 'name', label: 'Plataforma', align: 'left' },
...
export default function EcommerceProductList() {
  ...
  const handleEditRow = (id) => {
    push(PATH_DASHBOARD.integration.edit(id));
  };
  ...
  return (
    <Page title="Ecommerce: Product List">
      ...
      <Typography variant="h4">Integrações criadas</Typography>
      <NextLink href={PATH_DASHBOARD.integration.new} passHref>

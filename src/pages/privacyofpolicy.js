...
export default function PrivacyPolicy() {
    ...
    <Page title='Privacy of Policy'>
        <RootStyle>
      <Container>
        <h2>Okahub - Pol&iacute;tica Privacidade</h2>
  <p>A sua privacidade &eacute; importante para n&oacute;s. &Eacute; pol&iacute;tica do Okahub respeitar a sua privacidade em rela&ccedil;&atilde;o a qualquer informa&ccedil;&atilde;o sua que possamos coletar no site <a href="https://Okahub.app">Okahub</a>, e outros sites que possu&iacute;mos e operamos.</p>
  ...
  <h2>Pol&iacute;tica de Cookies Okahub</h2>
  ...
  <p>O usu&aacute;rio se compromete a fazer uso adequado dos conte&uacute;dos e da informa&ccedil;&atilde;o que o Okahub oferece no site e com car&aacute;ter enunciativo, mas n&atilde;o limitativo:</p>
  <ul>
  ...
  <li>B) N&atilde;o divulgar conte&uacute;do ou propaganda de natureza racista, xenof&oacute;bica, <a href="https://ondeapostar.pt/">apostas online</a>, pornografia ilegal, de apologia ao terrorismo ou contra os direitos humanos;</li>
  <li>C) N&atilde;o causar danos aos sistemas f&iacute;sicos (hardwares) e l&oacute;gicos (softwares) do Okahub, de seus fornecedores ou terceiros, para introduzir ou disseminar v&iacute;rus inform&aacute;ticos ou quaisquer outros sistemas de hardware ou software que sejam capazes de causar danos anteriormente mencionados.</li>
  </ul>
  ...
  <p>Esta pol&iacute;tica &eacute; efetiva a partir de <strong>November</strong>/<strong>2020</strong>.</p>
</Container>
</RootStyle>
</Page>
    )

...
const navConfig = [
  ...
  // ----------------------------------------------------------------------
  {
    // subheader: 'general',
    items: [
      { title: 'Dashborad', path: PATH_DASHBOARD.general.analytics, icon: ICONS.analytics },
  ...
  {
    subheader: 'Integração',
    items: [
      {
        title: 'todas',
        path: PATH_DASHBOARD.integration.list,
      },
      {
        title: 'criar nova',
        path: PATH_DASHBOARD.integration.new,
      },
      // {
      //   title: 'apps',
      ...
      //   icon: ICONS.cart,
      //   children: [
      //     { title: 'shop', path: PATH_DASHBOARD.integration.shop },
      //     { title: 'product', path: PATH_DASHBOARD.integration.demoView },
      //     { title: 'list', path: PATH_DASHBOARD.integration.list },
      //     { title: 'create', path: PATH_DASHBOARD.integration.new },
      //     { title: 'edit', path: PATH_DASHBOARD.integration.demoEdit },
      //     { title: 'checkout', path: PATH_DASHBOARD.integration.checkout },
      //   ],
      // },
    ],
  },
